...
public interface StudentDao {
    ...
    @Results(
        ...
        value={
            ...
            @Result(property="classc", javaType=Classc.class, column="banji",one=@One(select="selectDept",fetchType= FetchType.LAZY))
        }
    )
    ...
    @Select("select * from class where banji = #{banji}")
    public Classc selectDept(String banji);  // String banji 就是上面 column 指定的字段，名字随意
}
```
